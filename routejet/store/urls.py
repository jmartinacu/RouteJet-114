...
urlpatterns = [
    ...
    path("cart/create/", views.order_create_with_cart,
         name="order_create_with_cart"),
    path("create/<int:product_id>/", views.order_create_without_cart,
         name="order_create_without_cart"),
