...
class OrderCreateForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'payment_on_delivery', 'shipping_type'
        ]
...
class ClaimForm(forms.Form):
    order_id = forms.IntegerField(
        label="Id Reclamación", widget=forms.TextInput(attrs={'class': 'form-control'}))
    claim_text = forms.CharField(
        label="Descripcion", widget=forms.Textarea(attrs={'class': 'form-control'}))
